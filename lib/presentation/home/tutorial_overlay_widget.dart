...
class _TutorialOverlayState extends ConsumerState<TutorialOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    if (firstPlaygroundComponent != null &&
      ...
      highlightPlayground = Rect.fromLTWH(topLeft.x, topLeft.y, size.x, size.y);
    }
    ...
    if (openUpgradePanelButtonComponent != null &&
      ...
      final topLeft = openUpgradePanelButtonComponent.absoluteTopLeftPosition;
    ...
    final switchSceneComponent = firstPlaygroundComponent?.switchSceneComponent;
    ...
    final switchSceneButtonTwoComponent =
        firstPlaygroundComponent?.secondSwitchButton;
    ...
    final switchSceneButtonThreeComponent =
        firstPlaygroundComponent?.thirdSwitchButton;
    Rect? highlightSwitchSceneButtonThree;
    if (switchSceneButtonThreeComponent != null &&
        switchSceneButtonThreeComponent.isMounted) {
      final topLeft = switchSceneButtonThreeComponent.absoluteTopLeftPosition;
